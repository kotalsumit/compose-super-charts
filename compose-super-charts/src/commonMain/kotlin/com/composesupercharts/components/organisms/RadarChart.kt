...
import com.composesupercharts.utils.ChartAccessibility.radarChartDescription
...
fun RadarChart(
    ...
    BoxWithConstraints(modifier = modifier.padding(config.padding).semantics { radarChartDescription(data) }) {
